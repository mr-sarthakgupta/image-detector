...
function V(a,b){var c=arguments.length-2,d=arguments;return La(()=>{for(var g=Ma(8*c),h=g>>>3,k=0;k<c;k++){var t=d[2+k];ea()[h+k>>>0]=t}return Na(a,c,g,b)})}function Oa(a){if(D)return V(0,1,a);L=a;0<T||(S.lb(),v.onExit?.(a),K=!0);z(a,new R(a))}var Qa=a=>{L=a;if(D)throw Pa(a),"unwind";Oa(a)};function Ra(){for(var a=v.numThreads;a--;)Ga();ua.unshift(()=>{M++;Sa(()=>ya())})}function Ga(){var a=la("ort-wasm-simd-threaded.worker.js");a=new Worker(a);S.Pa.push(a)}
