...
var ka=a=>a.startsWith("data:application/octet-stream;base64,"),C=a=>a.startsWith("file://"),P;P="ort-wasm-simd.wasm";if(!ka(P)){var la=P;P=f.locateFile?f.locateFile(la,v):v+la}function ma(a){if(A)return A(a);throw"both async and sync fetching of the wasm failed";}
